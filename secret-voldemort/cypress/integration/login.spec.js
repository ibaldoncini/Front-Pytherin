...
context('User login', () => {
    describe('Accessing the login page', () => {
        it("Try to access the login page it should display an h1", () => {
            ...
            cy.get("h2").containt("To play you need to be logged in")
        })
    })
    ...
    describe('All OK', () => {
        it("Try to login with correct data. Should login", () => {
            ...
            cy.get('#change').should("be.visible").and("contain", "Change nickname")
            cy.get('#profile').should("be.visible").and("contain", "Profile")
